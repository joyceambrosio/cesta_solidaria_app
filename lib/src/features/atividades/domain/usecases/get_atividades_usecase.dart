...
class GetAtividadesUsecase extends ErroHandler<List<AtividadeEntity>> {
  final AtividadeRepository repository;

  GetAtividadesUsecase(this.repository);

  Future<Either<ErroApp, List<AtividadeEntity>>> getAtividades(
      Map<String, dynamic> queryParams) async {
    var result = await repository.getAtividades(queryParams);
